...
<body>
    ...
    <a href="../dashboard.php" style="margin-left: 1em; margin-top: 2rem;">
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
            class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16" style="color:green">
            <path
                    ...
                    <div class="card-body">
                        ...
                        <a href="editBarang.php?id=<?=$row['id_barang']?>" class="card-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-pencil-fill" viewBox="0 0 16 16" style="color:#14C38E">
                                <path
                        ...
                        <a href="../controller/delbarang.php?id=<?=$row['id_barang']?>" class="card-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-trash-fill" viewBox="0 0 16 16" style="color:#14C38E">
                                <path
