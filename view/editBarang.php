...
*{
  ...
  <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="input" name="input"  value="<?=$hasil['kode_barang']?>">
            <input type="text" class="form-control" id="id_barang" name="id_barang"  hidden value="<?=$hasil['id_barang']?>">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="harga_barang" name="harga_barang"  value="<?=$hasil['harga_barang']?>" >
          </div>
            <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Jumlah</label>
            <input type="text" class="form-control" id="jml_barang" name="jml_barang"  value="<?=$hasil['jml_barang']?>" >
          </div>
  ...
  $(document).ready(function(){
    ...
    $('#btn_simpan').click(function(){
      ...
      if(id_barang !==""  & input !=="" & nama_barang !=="" & harga_barang!=="" & jml_barang!==""){
        $.ajax({
          type: 'POST',
          url: '../controller/editbarang.php',
          data: {"id_barang":id_barang,"input":input,"nama_barang":nama_barang,"harga_barang":harga_barang,"jml_barang":jml_barang},
          ...
          success:function(response) {
            $('#message_info').html("");
            alert(response);
            $('#id_barang,#input,#nama_barang,#harga_barang,#jml_barang').val("");
            $('#input').focus();
          }
        });
      } else {
